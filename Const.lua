...
ABP_SIMILAR_SPELLS = {
    ...
    [312202] = { 315443, 324128, 311648 },  -- Shackle the Unworthy
    [315443] = { 312202, 324128, 311648 },  -- Abomination Limb
    [324128] = { 312202, 315443, 311648 },  -- Death's Due
    [311648] = { 312202, 315443, 324128 },  -- Swarming Mist

    [306830] = { 329554, 323639, 306830 },  -- Elysian Decree
    [329554] = { 306830, 323639, 306830 },  -- Fodder to the Flame
    [323639] = { 306830, 329554, 306830 },  -- The Hunt

    [326434] = { 325727, 323764, 323546 },  -- Kindred Spirits
    [325727] = { 326434, 323764, 323546 },  -- Adaptive Swarm
    [323764] = { 326434, 325727, 323546 },  -- Convoke the Spirits
    [323546] = { 326434, 325727, 323764 },  -- Ravenous Frenzy

    [308491] = { 325028, 328231, 324149 },  -- Resonating Arrow
    [325028] = { 308491, 328231, 324149 },  -- Death Chakram
    [328231] = { 308491, 325028, 324149 },  -- Wild Spirits
    [324149] = { 308491, 325028, 328231 },  -- Flayed Shot

    [307443] = { 324220, 314791, 314793 },  -- Radiant Spark
    [324220] = { 307443, 314791, 314793 },  -- Deathborne
    [314791] = { 307443, 324220, 314793 },  -- Shifting Power
    [314793] = { 307443, 324220, 314791 },  -- Mirrors of Torment

    [310454] = { 325216, 327104, 326860 },  -- Weapons of Order
    [325216] = { 310454, 327104, 326860 },  -- Bonedust Brew
    [327104] = { 310454, 325216, 326860 },  -- Faeline Stomp
    [326860] = { 310454, 325216, 327104 },  -- Fallen Order

    [304971] = { 328204, 328278, 316958 },  -- Divine Toll
    [328204] = { 304971, 328278, 316958 },  -- Vanquisher's Hammer
    [328278] = { 304971, 328204, 316958 },  -- Blessing of the Seasons
    [316958] = { 304971, 328204, 328278 },  -- Ashen Hallow

    [325013] = { 324724, 327661, 323673 },  -- Boon of the Ascended
    [324724] = { 325013, 327661, 323673 },  -- Unholy Nova
    [327661] = { 325013, 324724, 323673 },  -- Fae Guardians
    [323673] = { 325013, 324724, 327661 },  -- Mindgames

    [323547] = { 328547, 328305, 323654 },  -- Echoing Reprimand
    [328547] = { 323547, 328305, 323654 },  -- Serrated Bone Spike
    [328305] = { 323547, 328547, 323654 },  -- Sepsis
    [323654] = { 323547, 328547, 328305 },  -- Flagellation

    [324386] = { 326059, 328923, 320674 },  -- Vesper Totem
    [326059] = { 324386, 328923, 320674 },  -- Primordial Wave
    [328923] = { 324386, 326059, 320674 },  -- Fae Transfusion
    [320674] = { 324386, 326059, 328923 },  -- Chain Harvest

    [312321] = { 325289, 325640, 321792 },  -- Scouring Tithe
    [325289] = { 312321, 325640, 321792 },  -- Decimating Bolt
    [325640] = { 312321, 325289, 321792 },  -- Soul Rot
    [321792] = { 312321, 325289, 325640 },  -- Impending Catastrophe

    [307865] = { 324143, 325886, 317349 },  -- Spear of Bastion
    [324143] = { 307865, 325886, 317349 },  -- Conqueror's Banner
    [325886] = { 307865, 324143, 317349 },  -- Ancient Aftershock
    [317349] = { 307865, 324143, 325886 },  -- Condemn
}
